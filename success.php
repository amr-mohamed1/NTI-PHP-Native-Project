...
if (array_key_exists('paymentId', $_GET) && array_key_exists('PayerID', $_GET)) {
    ...
    if ($response->isSuccessful()) {
        ...
        global $con;
        $stmt = $con->prepare("INSERT INTO payments(payment_id,payment_state,Payment_User_Id,payer_id,payer_email,payer_shipping_address,amount) Value(:payment_id ,:payment_state,:Payment_User_Id ,:payer_id,:payer_email,:payer_shipping_address,:amount)");
        $stmt->execute(
        array(
